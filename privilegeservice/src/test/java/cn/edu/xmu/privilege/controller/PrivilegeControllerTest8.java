...
public class PrivilegeControllerTest8 {
    ...
    public  void approveUser1() throws Exception {
        ...
        try
        {
            responseString = this.mvc.perform(get("/shops/0/adminusers/1/approve").header("authorization", token).content(approve))
    ...
    public  void approveUser3() throws Exception {
        String token=creatTestToken(1000L,0l,100);
        String responseString="";
        String approve=JacksonUtil.toJson(true);
        try
        {
            responseString = this.mvc.perform(get("/shops/0/adminusers/2/approve").header("authorization", token).content(approve))
