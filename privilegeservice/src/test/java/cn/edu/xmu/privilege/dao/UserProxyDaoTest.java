...
//        ReturnObject returnObject =  userProxyDao.usersProxy(aId, bId, bo);
...
//        userProxyVo.setEndDate("2020-10-11 00:00:00");
//        UserProxy bo=new UserProxy(userProxyVo);
//        ReturnObject returnObject =  userProxyDao.aUsersProxy(aId, bId, bo);
//        assertEquals(0, returnObject.getCode().getCode());
//    }
//
//    @Test
...
//        ReturnObject<List> results = userProxyDao.listProxies(null, null);
...
//        Long id = 1L;
//        ReturnObject returnObject =  userProxyDao.removeAllProxies(id);
//        assertEquals(0, returnObject.getCode().getCode());
//    }
//
//}
