package cn.edu.xmu.freight.util;
...
public enum ResponseCode {
     ...
     *    订单模块错误码
     **************************************************/
    FREIGHTMODEL_SHOP_NOTFIT(804,"该店铺无此运费模板"),
    FREIGHTMODEL_REGION_HASEXISTED(803,"运费模板中该地区已经定义"),
    FREIGHTMODEL_NAME_HASEXISTED(802, "运费模板名重复"),
